...
class Create{
    ...
    private $action = 'write'; //CRUD-операции, по умолчанию read
    ...
    public function AddAlbumForm($class, $action, $params )
    {
        $class = 'AddAlbumForm';
    ...
    public function AddIMGForm($class, $action, $params )
    {
        $class = 'AddIMGForm';
       // var_dump($params);
        //Модель:
    ...
    public function AddAlbum($class, $action, $params )
    {
        $class = 'AddAlbum';
    ...
    public function AddIMG($class, $action, $params )
    {
        $class = 'AddIMG';
      ...
      //  header('Location: '.'/PhotoLists/CreateAlbumForm');
